...
- (void)viewDidLoad {
    ...
    if (self.savedFolder) {
//        [self generatePathsFromEndPointFoldertoRoot:self.savedFolder];
...
//        [self.tabBarController.delegate tabBarController:self.tabBarController shouldSelectViewController:[[self.tabBarController viewControllers] objectAtIndex:[self.savedFolder.type isEqual:@"personal"] ? 0 :1]];
//    }
